...
- (void)getHomeServiewData{
    ...
    [[MTNetworkSingletion shareManager] getHomeServiceResult:nil url:urlStr success:^(id responseBody) {
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row == 0) {
        ...
        if (_homeServiceArray.count!=0) {
            int y = (int)(_homeServiceArray.count +2-1)/2;
            return 125*y+5;
        }else{
            return 125*5+5;
        }
